# Arquitectura de referencia — versión histórica (fase Foundation, previa a G3.3)

> **Superseded.** El modelo de arquitectura vigente es
...
> Foundation), que reemplaza el modelo de 3 capas de esta página. Este archivo histórico
> se conserva por su contenido FACT todavía válido (stack del KO, tabla de integraciones a
> incorporar) — no se duplica en el documento vigente, se referencia desde ahí.
