...
**Fase**: G3.3. **Estado**: PROPOSAL. Este documento **reemplaza y consolida**
[`../../architecture/reference-architecture.md`](../../architecture/reference-architecture.md)
(fase Foundation, G1) — ese archivo queda como pointer histórico, su contenido válido
(stack FACT del KO) se conserva y se referencia desde acá. Es el documento capstone de
G3.3: conecta `operating-model.md`, `capability-model.md`, `lifecycle.md`,
`assessment-gate.md`, `capability-registry.md`, `security-governance.md`,
`evaluation-observability.md` y `golden-paths.md` en una sola arquitectura lógica.
