...
|---|---|---|---|---|---|---|---|
| [CAP-001](entries/user-story.md) | user-story | Skill | DataAgro, Scato Logística, Orquestador, Portal de Créditos (AWS) | N | VERIFIED (2/3) · PARTIAL (DataAgro) | **EXECUTED** — 2 ejecuciones reales vía Agent Plugin sobre Portal de Créditos (2026-09-23 y 2026-09-24). Evaluación `model-assisted` `PARTIAL`, humana pendiente | Bajo |
