...
| **Reusable Asset** *(nuevo en G5.1)* | [`capabilities/skills/stack-best-practices-template/SKILL.md`](../../capabilities/skills/stack-best-practices-template/SKILL.md) | Plantilla de 8 secciones, deliberadamente sin contenido de ejemplo de stack — ver la propia plantilla para la justificación de por qué no incluir un ejemplo. **Actualizado 2026-09-22**: se agregó una sección de referencias oficiales (Angular Signals, `angular.dev`) como excepción deliberada, para que un stack real confirmado de MOA (Angular 20+/21) tenga un punto de partida opinado en vez de que la IA improvise una regla distinta cada sesión (ver [[moa_capability_design_principles]], principio 3) |
