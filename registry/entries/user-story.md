...
| **Real Use Status** | **EXECUTED** *(5 ejecuciones registradas — 2 Direct Context: G4.4 y G4.6; 3 Connected Context: `EXEC-20260908-003/004/005`)*. Escala usada: `NOT FOUND / CONFIGURED / EXECUTED / VERIFIED`. **No es `VERIFIED`**: las 2 primeras ejecuciones (`EXEC-20260907-001` sobre MOA-1816, `EXEC-20260908-001` sobre MOA-1765) fueron CONTROLLED DRY-RUN con Direct Context; las 3 adicionales (`EXEC-20260908-003` Azure DevOps, `EXEC-20260908-004`/`EXEC-20260908-005` Jira/MCP) fueron con Connected Context vía Context Provider — las 5 fueron realizadas por el mismo agente que diseñó la capability, no por un miembro independiente de un equipo de MOA — sigue sin haber confirmación humana independiente. G4.6 sumó una segunda ejecución Direct Context sobre un ticket real distinto específicamente para probar generalización; el vertical slice de Context Acquisition & Resolution sumó las 3 restantes para probar el modo Connected Context | Configuration Status sigue sin usarse para inferir esto — es evidencia directa de 5 ejecuciones reales registradas, distintas de la configuración |
| **Lifecycle State** | Pilot | 5 ejecuciones + 5 autoevaluaciones `PARTIAL`, sin Measurement logrado ni HITL humano confirmado — no alcanza para `Measure`/`Human Validation` (`lifecycle.md`) |
| **Corporate Standard** | N | Sin decisión de gobierno — 5 ejecuciones no independientes no son base suficiente, independientemente de que todas dieran `PARTIAL` |
...
| **Evidence Reference** *(actualizado tras el vertical slice de Context Acquisition & Resolution)* | [`evidence/EXEC-20260907-001.md`](../../evidence/EXEC-20260907-001.md) (MOA-1816, G4.4), [`evidence/EXEC-20260908-001.md`](../../evidence/EXEC-20260908-001.md) (MOA-1765, G4.6), [`evidence/EXEC-20260908-003.md`](../../evidence/EXEC-20260908-003.md) (Azure DevOps #7, Resolved Context vía CAP-007), [`evidence/EXEC-20260908-004.md`](../../evidence/EXEC-20260908-004.md) (Jira `ARMOA277-191`, Resolved Context vía CAP-008/MCP), [`evidence/EXEC-20260908-005.md`](../../evidence/EXEC-20260908-005.md) (Jira `ARMOA277-180`, Resolved Context vía CAP-008/MCP, segundo tipo de issue) | 5 ejecuciones reales — 2 Direct Context (DataAgro), 3 Connected Context (Azure DevOps, Jira x2) |
| **Evaluation Reference** *(actualizado)* | [`evaluation/EXEC-20260907-001.md`](../../evaluation/EXEC-20260907-001.md), [`evaluation/EXEC-20260908-001.md`](../../evaluation/EXEC-20260908-001.md), [`evaluation/EXEC-20260908-003.md`](../../evaluation/EXEC-20260908-003.md), [`evaluation/EXEC-20260908-004.md`](../../evaluation/EXEC-20260908-004.md), [`evaluation/EXEC-20260908-005.md`](../../evaluation/EXEC-20260908-005.md) | Resultado en las 5: `PARTIAL`, autoevaluación (`method: model-assisted`), HITL real pendiente en todas |
| **Metric Reference** *(actualizado)* | [`measurements/EXEC-20260907-001.md`](../../measurements/EXEC-20260907-001.md), [`measurements/EXEC-20260908-001.md`](../../measurements/EXEC-20260908-001.md), [`measurements/EXEC-20260908-003.md`](../../measurements/EXEC-20260908-003.md), [`measurements/EXEC-20260908-004.md`](../../measurements/EXEC-20260908-004.md), [`measurements/EXEC-20260908-005.md`](../../measurements/EXEC-20260908-005.md) | `NOT MEASURED` en las 5 — sin baseline, y ejecuciones puntuales del mismo actor no forman una serie comparable |
