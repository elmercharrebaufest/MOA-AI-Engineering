...
| **Real Use Status** | **EXECUTED** *(7 ejecuciones registradas — 2 Direct Context: G4.4 y G4.6; 5 Connected Context: `EXEC-20260908-003/004/005`, `EXEC-20260909-001`, `EXEC-20260917-001`)*. Escala usada: `NOT FOUND / CONFIGURED / EXECUTED / VERIFIED`. **No es `VERIFIED`**: las 2 primeras ejecuciones (`EXEC-20260907-001` sobre MOA-1816, `EXEC-20260908-001` sobre MOA-1765) fueron CONTROLLED DRY-RUN con Direct Context; las 5 adicionales (`EXEC-20260908-003` Azure DevOps, `EXEC-20260908-004`/`EXEC-20260908-005`/`EXEC-20260909-001`/`EXEC-20260917-001` Jira/MCP) fueron con Connected Context vía Context Provider — las 7 fueron realizadas por el mismo agente que diseñó la capability (el campo `actor` de cada Evidence Record es genérico y no declara un desarrollador independiente de un equipo de MOA) — sigue sin haber confirmación humana independiente. G4.6 sumó una segunda ejecución Direct Context sobre un ticket real distinto específicamente para probar generalización; el vertical slice de Context Acquisition & Resolution sumó 4 más para probar el modo Connected Context sobre tipos de issue Jira distintos (`Error`/Bug, `Tarea`/Task, `Test`/Xray); `EXEC-20260917-001` sumó un cuarto tipo (`Historia`/Story, sin descripción) | Configuration Status sigue sin usarse para inferir esto — es evidencia directa de 7 ejecuciones reales registradas, distintas de la configuración |
| **Lifecycle State** | Pilot | 7 ejecuciones + 7 autoevaluaciones `PARTIAL`, sin Measurement logrado ni HITL humano confirmado — no alcanza para `Measure`/`Human Validation` (`lifecycle.md`) |
| **Corporate Standard** | N | Sin decisión de gobierno — 7 ejecuciones no independientes no son base suficiente, independientemente de que todas dieran `PARTIAL` |
...
| **Evidence Reference** *(actualizado tras la cuarta ejecución MCP)* | [`EXEC-20260907-001`](../../records/jira-MOA-1816/EXEC-20260907-001/evidence.md) (MOA-1816, G4.4), [`EXEC-20260908-001`](../../records/jira-MOA-1765/EXEC-20260908-001/evidence.md) (MOA-1765, G4.6), [`EXEC-20260908-003`](../../records/ado-7/EXEC-20260908-003/evidence.md) (Azure DevOps #7, Resolved Context vía CAP-007), [`EXEC-20260908-004`](../../records/jira-ARMOA277-191/EXEC-20260908-004/evidence.md) (Jira `ARMOA277-191`, Resolved Context vía CAP-008/MCP), [`EXEC-20260908-005`](../../records/jira-ARMOA277-180/EXEC-20260908-005/evidence.md) (Jira `ARMOA277-180`, Resolved Context vía CAP-008/MCP, segundo tipo de issue), [`EXEC-20260909-001`](../../records/jira-ARMOA277-45/EXEC-20260909-001/evidence.md) (Jira `ARMOA277-45`, Resolved Context vía CAP-008/MCP, tercer tipo de issue), [`EXEC-20260917-001`](../../records/jira-ARMOA277-194/EXEC-20260917-001/evidence.md) (Jira `ARMOA277-194`, Resolved Context vía CAP-008/MCP, cuarto tipo de issue) | 7 ejecuciones reales — 2 Direct Context (DataAgro), 5 Connected Context (Azure DevOps, Jira x4) |
| **Evaluation Reference** *(actualizado)* | [`EXEC-20260907-001`](../../records/jira-MOA-1816/EXEC-20260907-001/evaluation.md), [`EXEC-20260908-001`](../../records/jira-MOA-1765/EXEC-20260908-001/evaluation.md), [`EXEC-20260908-003`](../../records/ado-7/EXEC-20260908-003/evaluation.md), [`EXEC-20260908-004`](../../records/jira-ARMOA277-191/EXEC-20260908-004/evaluation.md), [`EXEC-20260908-005`](../../records/jira-ARMOA277-180/EXEC-20260908-005/evaluation.md), [`EXEC-20260909-001`](../../records/jira-ARMOA277-45/EXEC-20260909-001/evaluation.md), [`EXEC-20260917-001`](../../records/jira-ARMOA277-194/EXEC-20260917-001/evaluation.md) | Resultado en las 7: `PARTIAL`, autoevaluación (`method: model-assisted`), HITL real pendiente en todas |
| **Metric Reference** *(actualizado)* | [`EXEC-20260907-001`](../../records/jira-MOA-1816/EXEC-20260907-001/measurement.md), [`EXEC-20260908-001`](../../records/jira-MOA-1765/EXEC-20260908-001/measurement.md), [`EXEC-20260908-003`](../../records/ado-7/EXEC-20260908-003/measurement.md), [`EXEC-20260908-004`](../../records/jira-ARMOA277-191/EXEC-20260908-004/measurement.md), [`EXEC-20260908-005`](../../records/jira-ARMOA277-180/EXEC-20260908-005/measurement.md), [`EXEC-20260909-001`](../../records/jira-ARMOA277-45/EXEC-20260909-001/measurement.md), [`EXEC-20260917-001`](../../records/jira-ARMOA277-194/EXEC-20260917-001/measurement.md) | `NOT MEASURED` en las 7 — sin baseline, y ejecuciones puntuales del mismo actor no forman una serie comparable |
