...
**Sin registros todavía** — ver [`../evidence/README.md`](../evidence/README.md) para el
estado vivo (las evaluaciones que existieron fueron de pruebas del mecanismo, purgadas al
pasar a adopción real).
