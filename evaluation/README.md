...
| [`EXEC-20260917-001`](../records/jira-ARMOA277-194/EXEC-20260917-001/evaluation.md) | ARMOA277-194 | [`evidence.md`](../records/jira-ARMOA277-194/EXEC-20260917-001/evidence.md) (vertical slice CAP-008 MCP → CAP-002, issue Historia/Story, **actor independiente**, incluye la nueva Recomendación) | `model-assisted` (no `human`) | `PARTIAL` |
...
(`../governance/BLOCKED-DECISIONS.md` #1) — independiente de que `EXEC-20260909-001` y
`EXEC-20260917-001` sí tengan un **actor de ejecución** independiente (`PILOT-003` y
ARMOA277-194); son 2 ejes distintos. Un resultado `model-assisted` no sustituye una
